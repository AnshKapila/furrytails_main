...
placeholder shapes that the website-code-writing prompt forbids but the LLM
        ...
        issues.append(
            {
                ...
                "hint": (
                    ...
                    f"props, authored in seed.json), or remove the element. See website-code-writing "
